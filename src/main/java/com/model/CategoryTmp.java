...
public class CategoryTmp {
    ...
    public String getKeyIdAndProperty(){
        return this.firstCategory+"_"+this.secondCategory+"_"+this.thirdCategory+"_"+this.fourthCategory+"_"+this.getProperty();
    }

    public String getPropertyKeyId(){
        return this.property+"_"+this.propertyType;
    }
}